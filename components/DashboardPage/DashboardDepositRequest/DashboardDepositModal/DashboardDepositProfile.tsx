...
const DashboardDepositProfile = () => {
  ...
  const handleUploadProfilePicture = async (file: File) => {
    ...
    try {
      ...
      const publicUrl = `${process.env.NODE_ENV === "development" ? `${process.env.NEXT_PUBLIC_SUPABASE_URL}` : "https://cdn.omnix-global.com"}/storage/v1/object/public/USER_PROFILE/${filePath}`;
