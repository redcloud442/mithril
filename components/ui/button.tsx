  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:focus-visible:ring-neutral-300 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        card: "bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-extrabold text-lg px-8 py-2 rounded-full shadow-md hover:brightness-110 transition duration-300",
        destructive:
          "bg-red-500 text-neutral-50 shadow-xs hover:bg-red-500/90 dark:bg-red-900 dark:text-neutral-50 dark:hover:bg-red-900/90",
        outline:
          "border border-color-primary bg-white shadow-xs hover:bg-neutral-100 hover:text-neutral-900 dark:border-color-primary dark:bg-gray-400 text-black dark:hover:bg-neutral-800 dark:hover:text-neutral-50 rounded-md cursor-pointer",
        secondary:
